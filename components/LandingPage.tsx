    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-5 py-20 overflow-hidden">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="relative w-full">
          ...
          <h1 className="font-display font-bold text-[clamp(3rem,8vw,6rem)] leading-[0.95] tracking-[-0.04em] text-ink mb-6 relative z-10">
        ...
        <motion.p
          variants={fadeInUp}
          className="font-sans font-light text-dim max-w-prose text-lg mb-8 leading-relaxed"
        >
        ...
        <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 mb-10">
          {hasSession ? (
            <Link
              href="/dashboard"
              className="inline-flex items-center justify-center bg-[var(--color-panini-blue)] text-white font-mono uppercase tracking-widest font-bold py-5 px-10 text-lg shadow-panini hover:shadow-panini-hover rounded-md transition-all"
            >
              IR A MI DASHBOARD
            </Link>
          ) : (
            <>
              <Link
                href="/register"
                className="inline-flex items-center justify-center bg-[var(--color-panini-blue)] text-white font-mono uppercase tracking-widest font-bold py-4 px-8 shadow-panini hover:shadow-panini-hover rounded-md transition-all"
              >
                Empezar a jugar
              </Link>
              <Link
                href="/login"
                className="inline-flex items-center justify-center bg-white text-ink border border-hair2 font-mono uppercase tracking-widest font-bold py-4 px-8 shadow-sm hover:shadow-md rounded-md transition-all"
              >
                Ya tengo cuenta
              </Link>
            </>
